...
2) Move the plugin folder called awsompixgallery to your website’s wp-content/plugin folder (please note it MUST be called awsompixgallery).
...
4) Log into your site and go to the Admin area and click the link to Plugins. Find the AWSOM Pixgallery entry (it will be called PixGallery, but list AWSOM Mods in its description). Click the Activate link next to the plugin.
...
To upgrade from a previous version to the 4.5.X version:
...
3) copy the new awsompixgallery plugin folder to the wp-content/plugins folder (please note the folder name now MUST be awsompixgallery)

4) go to the Admin Plugins menu and activate the 4.5.X version.
...
7) AWSOM Pixgallery now also has the ability to create a default gallery folder in your uploads folder. You can create this folder by going to the Manage Galleries admin
