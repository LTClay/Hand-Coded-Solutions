...
function PixGallery_Initialize()
{
	...
	PreloadedImage[0].src = "<?=get_option('siteurl')?>/wp-content/plugins/awsompixgallery/images/loading.gif";
	PreloadedImage[1] = new Image();
	PreloadedImage[1].src = "<?=get_option('siteurl')?>/wp-content/plugins/awsompixgallery/images/background.gif";
